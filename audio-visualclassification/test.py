...
def general_model_test():
    ...
    model_path=".\\results\ks\pme_share\\best_model_of_dataset_KineticSound_Normal_beta_0.5_pe_0_optimizer_sgd_modulate_starts_0_ends_50_epoch_80_acc_0.5939987752602572.pth"
