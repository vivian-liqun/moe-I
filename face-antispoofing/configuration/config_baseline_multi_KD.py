...
parser.add_argument('--pre_teacher_root', type=str, default='.\pre_teacher\\Unif_T.pth')
...
parser.add_argument('--p', type=str,default=[0, 0, 0], help='para for modality dropout')
parser.add_argument("--protocol", type=str, default='race_'
                                                    'prot_rdi_4@3')
...
parser.add_argument('--data_root', type=str,default='.\data\CASIA-SURF-Challenge')
parser.add_argument('--modal', type=str, default='multi')
parser.add_argument('--backbone', type=str, default='CED_KD')
parser.add_argument('--gpu', type=int, default=1)
parser.add_argument('--version', type=int, default=15)

args = parser.parse_args()
args.backbone = args.backbone + '_' + str(args.version)
